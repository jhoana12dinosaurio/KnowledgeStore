          ...
          <div className="lx-nav-ctas">
            {!isLoggedIn ? (
              <>
                ...
                {/* OPCIÓN A: Ir a la página /register como en la V1 */}
                <button className="lx-btn lx-btn-primary" onClick={() => navigate('/register')}>
                  Comenzar gratis
                </button>

                {/* OPCIÓN B: Bajar a la sección de precios como en la V2 
                    (Descomenta la línea de abajo y borra la de arriba si prefieres esta) */}
